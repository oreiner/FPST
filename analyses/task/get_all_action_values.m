function get_all_action_values()
    ...
    %get actionValues
    ActionValuesUnitary = load('action_values_task_results_only_learn_phase_unitary_normal_temperature');
    ...
    y = [0.8, meanContingenciesReorderd(1) ,meanAsymReorderd(1), meanUnitaryReorderd(1); ...
         ...
         0.3, meanContingenciesReorderd(5) ,meanAsymReorderd(5), meanUnitaryReorderd(5); ...
         0.2, meanContingenciesReorderd(6) ,meanAsymReorderd(6), meanUnitaryReorderd(6)];
    err = [0, stdContingenciesReorderd(1) ,stdAsymReorderd(1), stdUnitaryReorderd(1); ...
         0, stdContingenciesReorderd(2) ,stdAsymReorderd(2), stdUnitaryReorderd(2); ...
         0, stdContingenciesReorderd(3) ,stdAsymReorderd(3), stdUnitaryReorderd(3); ...
         0, stdContingenciesReorderd(4) ,stdAsymReorderd(4), stdUnitaryReorderd(4); ...
         0, stdContingenciesReorderd(5) ,stdAsymReorderd(5), stdUnitaryReorderd(5); ...
         0, stdContingenciesReorderd(6) ,stdAsymReorderd(6), stdUnitaryReorderd(6)];
 ...
 %%bars
    ...
    legend('planned contigency','experienced contigency', 'SAV from asymmetrical learning', 'SAV from uniform learning');
   ...
   hold off
    ...
    saveas(graph,fullfile(resultspath,'action_values_graphs',['SAV with SD' ' color'] ),'png');
    saveas(graph,fullfile(resultspath,'action_values_graphs',['SAV with SD' ' color'] ),'svg');
    saveas(graph,fullfile(resultspath,'action_values_graphs',['SAV with SD' ' color'] ),'fig');
