...
display_char = '';
    ...
    %Loop and track mouse according to predefined sample time (edited from MouseTraceDemo)
    sampleTime = 0.01;
    startTime = GetSecs;
    nextTime = startTime+sampleTime;
    
    [mouseX, mouseY, mousebuttons] = GetMouse(screenNumber); %Find out coordinates of current mouse postition 
    ...
    while 1
        ...
        if (GetSecs > nextTime) %Sample every 0.01 seconds
            ...
            if mousebuttons(1)==1 %Terminate and record rating on left mouseclick
                ...
                if mouseX > x_pos_labels(1) && mouseX < (x_pos_labels(2)-15)
                    ...
                    break
                elseif mouseX > x_pos_labels(2) && mouseX < (x_pos_labels(3)-15)
                    ...
                    break
                elseif mouseX > x_pos_labels(3) && mouseX < (x_pos_labels(4)-15)
